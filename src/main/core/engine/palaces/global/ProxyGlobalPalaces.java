...
public class ProxyGlobalPalaces extends PalacesGlobal {

    private Logger logger = LoggerFactory.getLogger(ProxyGlobalPalaces.class);

    @Override
    public void excute(PalacesGlobalGoods goods, PalacesGlobalPersion palacesPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws Exception {
       try{
    ...
    @Override
    public void addCart(PalacesGlobalGoods goods, PalacesGlobalPersion palacesPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws URISyntaxException, BotException {
        super.addCart(goods, palacesPersion, web, httpUntil);
        TableMessQueue.getInstance().addMess(web.getIndex(),"添加购物车完成");
    }

    @Override
    public void cartCheckOut(PalacesGlobalGoods goods, PalacesGlobalPersion palacesPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws URISyntaxException, BotException {
    ...
    @Override
    public void paymentMethod(PalacesGlobalGoods goods, PalacesGlobalPersion palacesPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws URISyntaxException, BotException {
        super.paymentMethod(goods, palacesPersion, web, httpUntil);
        TableMessQueue.getInstance().addMess(web.getIndex(),"提交邮费完成");
    }

    @Override
    public void pay(PalacesGlobalGoods goods, PalacesGlobalPersion palacesPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws Exception {
