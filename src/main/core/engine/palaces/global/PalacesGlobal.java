 ...
 * 7 找货这一步根据关键方面要靠谱。
 */
public class PalacesGlobal extends CheckOutId implements APIEngine<PalacesGlobalGoods, PalacesGlobalPersion, PalacesGlobalWEB, HttpUntil> {
    private Logger logger = LoggerFactory.getLogger(PalacesGlobal.class);



    private void getNote(PalacesGlobalWEB web, HttpUntil httpUntil) throws BotException {
    ...
    private void contactInformation(HttpUntil httpUntil, PalacesGlobalWEB web) throws BotException {
     ...
     * @return
     */
    private RequestBuilder getCaptcha(RequestBuilder requestBuilder, boolean isCaptcha, PalacesGlobalWEB web) {
        if (isCaptcha) {
            String result = null;
    ...
    @Override
    public void addCart(PalacesGlobalGoods goods, PalacesGlobalPersion palacesGlobalPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws URISyntaxException, BotException {
    ...
    @Override
    public void cartCheckOut(PalacesGlobalGoods goods, PalacesGlobalPersion palacesGlobalPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws URISyntaxException, BotException {
        RequestBuilder builder = RequestBuilder.post()
    ...
    @Override
    public void shopingMethod(PalacesGlobalGoods goods, PalacesGlobalPersion palacesPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws URISyntaxException, BotException {
        RequestBuilder builder = RequestBuilder.post()
                ...
                .addParameter("checkout[shipping_address][phone]", palacesPersion.getPhone())
    ...
    @Override
    public void paymentMethod(PalacesGlobalGoods goods, PalacesGlobalPersion palacesGlobalPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws URISyntaxException, BotException {
    ...
    @Override
    public void excute(PalacesGlobalGoods goods, PalacesGlobalPersion palacesGlobalPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws Exception, BotException {

    }

    @Override
    public void pay(PalacesGlobalGoods goods, PalacesGlobalPersion palacesPersion, PalacesGlobalWEB web, HttpUntil httpUntil) throws Exception, BotException {
        String cartJson="";
        ...
        logger.info("card---->>:"+new StringEntity(cartJson, "UTF-8").toString());
        RequestBuilder builder = RequestBuilder.post()
